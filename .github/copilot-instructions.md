# Wardrobe Project - GitHub Copilot Instructions
...
## 🚨 MANDATORY: Always Follow Project Documentation

**CRITICAL**: Before implementing any feature, API call, or model interaction, you MUST consult and follow the documentation in the `docs_agent/` folder.
